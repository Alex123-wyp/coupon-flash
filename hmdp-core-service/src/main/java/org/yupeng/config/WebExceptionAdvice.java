...
public class WebExceptionAdvice {
    ...
    public Result<String> toolkitExceptionHandler(HttpServletRequest request, HmdpFrameException hmdpFrameException) {
        log.error("Business exception, message: {} method: {} url: {} query: {}", hmdpFrameException.getMessage(), request.getMethod(), getRequestUrl(request), getRequestQuery(request), hmdpFrameException);
    ...
    public Result<List<ArgumentError>> validExceptionHandler(HttpServletRequest request, MethodArgumentNotValidException ex) {
        log.error("Parameter validation exception, message: {} method: {} url: {} query: {}", ex.getMessage(), request.getMethod(), getRequestUrl(request), getRequestQuery(request), ex);
    ...
    public Result<String> defaultErrorHandler(HttpServletRequest request, Throwable throwable) {
        log.error("Unhandled exception, message: {} method: {} url: {} query: {}", throwable.getMessage(), request.getMethod(), getRequestUrl(request), getRequestQuery(request), throwable);
        return Result.fail();
    }
